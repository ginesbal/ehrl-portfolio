          ...
          {showcaseProjects.map((project, index) => (
            ...
            >
              <Link
                ...
                className="group relative block border-t border-border-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-taupe/40 focus-visible:ring-offset-4 focus-visible:ring-offset-bg-primary"
              >
