...
export default function ResumeModal({ isOpen, onClose }) {
    ...
    return (
        ...
        >
            ...
            {/* modal content */}
            <div
                className="relative w-full max-w-5xl h-[90vh] bg-white rounded-lg shadow-2xl flex flex-col"
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a
                            ...
                            className="px-5 py-2 text-[14px] rounded-lg transition-all hover:scale-105"
                            style={{
